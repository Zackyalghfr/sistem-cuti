  ...
  const html = `
    ...
    <body>
      <div class="header">
        ...
        <h3>Alamat: Jl. Ir. H. Juanda No.16, Paledang, Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat 16122| Telp: (0251) 8321758</h3>
      </div>
      ...
      <div class="isi">
        <p>Yang bertanda tangan di bawah ini, Kepala SMA Negeri 1 Bogor dengan ini menerangkan bahwa:</p>
        <table class="data">
